...
- create a new database for the course. Recommended to use phpMyAdmin. Copy existing course database structure and generate a general token using any random string generator tool;
...
- generate a Teacher Course Token (TCT) which should be different from the general token generated for the Diary Dashboard;
