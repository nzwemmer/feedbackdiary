$(document).ready(function() {
    ...
    $("input[name='form_selection']").on("change", function() {
      ...
      if (selectedForm === "diary") {
          $("#diaryForm").removeClass("hidden");
          $("#viewForm, #logoutForm").addClass("hidden");
      } else if (selectedForm === "history") {
          $("#viewForm").removeClass("hidden");
          $("#diaryForm, #logoutForm").addClass("hidden");
      } else if (selectedForm === "logout") {
          $("#logoutForm").removeClass("hidden");
          $("#diaryForm, #viewForm").addClass("hidden");
      }
    });

    // Trigger the change event initially to hide the forms
