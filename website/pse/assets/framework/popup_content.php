...
$popupContent .= 'And first of all, welcome also to Project Software Engineering 22/23! </br> Second of all: thank you for helping me with my thesis! </br> Please take some time to carefully read these instructions.';
...
$popupContent .= '<ul class="fa-list">';
$popupContent .= '<li class="fa-comments"> Discussed weekly with PSE staff.</li>';
