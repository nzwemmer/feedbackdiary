...
My name is Niels Zwemmer, masterstudent Software Engineering at the UvA. I am the creator of FeedbackDiary.

The following part is divided in sections, please take some time to read this information.
</br></br>
<b> The Goal: </b>
</br>
For my thesis, I have setup this platform: FeedbackDiary. You can use it throughout your course. 
With it, I aim to get student feedback more quickly, honestly and efficiently. Ideally I gather this feedback both implicitely and explicitely. This means you as a student are not required (but are allowed) to provide direct feedback.
...
Data collection is performed completely anonymously. All applicable students receive a general token, which can be used to create a personal token and password afterwards. THIS TOKEN IS NOT TO BE SHARED WITH PEOPLE OUTSIDE THE MASTER SE.
...
of information in the proper textfield. This information is used to determine the accuracy of the A.I. models used by comparing actual message type with determined sentiment type (very positive, positive, neutral, negative, very negative).
</br></br>
...
You supply a password. It is of course highly recommended not to re-use your password for any other service. Your password is encrypted and hashed according to the latest standards.
Any time communication with the database takes place, I have used prepared statements (PDO) in the code. This mitigates many security weaknesses. I have made sure to have a minimal amount of communication to the database.
</br></br>
<b> Contact: </b>
</br>
If you have any further questions or suggestions/bugreports, please contact me through the links in the footer. I speak both Dutch and English.
<br><br><br>
</p>