...
$popupContent .= 'And welcome also to ' . $course . " " . $year . '! </br> Providing feedback is often quite a chore. It takes a lot of time, ';
$popupContent .= 'it is usually only halfway through a course and at the very end, teachers often read it too late and students prefer anonymity, especially when being critical.';
$pupupContent .= '</br></br>Through FeedbackDiary, I try to make it easier and more accessible by letting you fill in only 3 questions every day (preferably). ';
$popupContent .= 'Teachers will be able to log their course on a daily basis and adjust their course as quickly as possible.';
$popupContent .= '</br></br>The goal? Improving courses <i>before</i> they end.</br></br> Please take some time to carefully read these instructions to understand how it works.';
...
$popupContent .= '<ul class="fa-list">';
$popupContent .= '<li class="fa-comments"> Discussed with ' . $course_short . ' staff.</li>';
