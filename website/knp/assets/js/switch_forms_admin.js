$(document).ready(function() {
    ...
    $("input[name='form_selection']").on("change", function() {
      ...
      if (selectedForm === "download") {
        ...
        $("#viewForm, #logoutForm, #adminPanelForm").addClass("hidden");
      } else if (selectedForm === "view") {
        $("#viewForm").removeClass("hidden");
        $("#downloadForm, #logoutForm, #adminPanelForm").addClass("hidden");
      } else if (selectedForm === "panel") {
        $("#adminPanelForm").removeClass("hidden");
        $("#downloadForm, #logoutForm, #viewForm").addClass("hidden");
      } else if (selectedForm === "logout") {
        $("#logoutForm").removeClass("hidden");
        $("#viewForm, #downloadForm, #adminPanelForm").addClass("hidden");
      }
    });
    ...
    $("#showAll").on("click", function(event) {
        ...
        toggleButtonAll(".token_button", '<i class="fa-solid fa-eye-slash"></i> <i class="fa-solid fa-user"></i>');
        toggleButtonAll(".group_button", '<i class="fa-solid fa-eye-slash"></i> <i class="fa-solid fa-users"></i>');
        ...
        toggleButtonAll(".emotion_button", '<i class="fa-solid fa-eye-slash"></i> <i class="fa-regular fa-face-laugh-wink"></i>');
    ...
    $("#showToken").on("click", function(event) {
        ...
        hide = '<i class="fa-solid fa-eye-slash"></i> <i class="fa-solid fa-user"></i>';
      ...
      $("#showGroups").on("click", function(event) {
        ...
        hide = '<i class="fa-solid fa-eye-slash"></i> <i class="fa-solid fa-users"></i>';
    ...
    $("#showTime").on("click", function(event) {
        event.preventDefault();
        element = ".time_button";
        hide = '<i class="fa-solid fa-eye-slash"></i> <i class="fa-solid fa-clock"></i>';
    ...
    $("#showPositive").on("click", function(event) {
        event.preventDefault();
        element = ".pos_button";
        hide = '<i class="fa-solid fa-eye-slash"></i> <i class="fa-solid fa-thumbs-up positive"></i>';
        show = '<i class="fa-solid fa-eye"></i> <i class="fa-solid fa-thumbs-up positive"></i>';
        toggleButton(element, hide, show);
    ...
    $("#showNegative").on("click", function(event) {
      event.preventDefault();
      element = ".neg_button";
      hide = '<i class="fa-solid fa-eye-slash"></i> <i class="fa-solid fa-thumbs-down negative"></i>';
      show = '<i class="fa-solid fa-eye"></i> <i class="fa-solid fa-thumbs-down negative"></i>';
      toggleButton(element, hide, show);
    ...
    $("#showAdditional").on("click", function(event) {
      event.preventDefault();
      element = ".add_button";
      hide = '<i class="fa-solid fa-eye-slash"></i> <i class="fa-solid fa-circle-question additional"></i>';
      show = '<i class="fa-solid fa-eye"></i> <i class="fa-solid fa-circle-question additional"></i>';
      toggleButton(element, hide, show);
    ...
    $("#showEmotion").on("click", function(event) {
      ...
      hide = '<i class="fa-solid fa-eye-slash"></i> <i class="fa-regular fa-face-laugh-wink"></i>';
      show = '<i class="fa-solid fa-eye"></i> <i class="fa-regular fa-face-laugh-wink"></i>';
      toggleButton(element, hide, show);
