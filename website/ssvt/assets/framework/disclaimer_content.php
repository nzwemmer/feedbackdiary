...
My name is Niels Zwemmer, masterstudent Software Engineering at the UvA and TA for the course Software Specification, Verification and Testing (SSVT) 2023/2024. 
...
For my thesis, I have setup this platform: FeedbackDiary. It will be used throughout the SSVT course. 
...
Data collection is performed completely anonymously. All SSVT students receive a general token, which can be used to create a personal token and password afterwards. THIS TOKEN IS NOT TO BE SHARED WITH PEOPLE OUTSIDE THE MASTER SE.
